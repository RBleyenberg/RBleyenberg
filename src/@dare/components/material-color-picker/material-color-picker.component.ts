...
import { MatColors } from '@dare/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const DARE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => DareMaterialColorPickerComponent),
    multi: true
};

@Component({
    selector: 'dare-material-color-picker',
    templateUrl: './material-color-picker.component.html',
    styleUrls: ['./material-color-picker.component.scss'],
    animations: dareAnimations,
    encapsulation: ViewEncapsulation.None,
    providers: [DARE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class DareMaterialColorPickerComponent implements ControlValueAccessor {
    colors: any;
    hues: string[];
    view: string;
    selectedColor: any;
    ...
    set color(value) {
        ...
        // Split the color value (red-400, blue-500, dare-navy-700 etc.)
